...
platform-general-find-corpora = Trova corpora per nome
...
common-by-link = Per link
common-allow-by-link = Consenti accesso da link
common-ready = Pronto
common-ok = Ok
...
common-time = Tempo
common-add-group = Aggiungi nuova collezione
common-group-settings = Impostazioni collezione
