WITH RECURSIVE fixed_parts AS
  (SELECT "interruptee"."char_range" AS "interruptee_char_range",
          ...
          "interruptee_agent"."agent" AS "interruptee_agent",
          ...
          "interruptor_agent"."agent" AS "interruptor_agent",
   ...
   WHERE "interruptee"."frame_range" && "interruptor"."frame_range"
     AND ("interruptor"."agent_id" != "interruptee"."agent_id"
          AND ((lower("interruptor"."frame_range") / 25.0))::numeric < ((upper("interruptee"."frame_range") / 25.0) - 1)::numeric)
     AND "interruptee_agent"."agent_id" = "interruptee"."agent_id"
